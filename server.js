...
// SCHEMAS //
// I asked chatgpt to give me an example of a schema of a car using mongodb, I followed their example with my own designs.
...
app.post('/submit', check_login, async function (req, res) {
    ...
    if (result) await auto_update_table(req, res);
...
app.post('/delete', check_login, async function (req, res) {
    ...
    if (deleted) await auto_update_table(req, res);
